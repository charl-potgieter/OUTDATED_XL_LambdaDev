Attribute VB_Name = "ZZZ_OUTDATED_SundryUtilities"
'Option Explicit
'Option Private Module
'
''-----------------------------------------------------------------------------
''   Original code in this module is maintained in SpreadsheetBI
''   https://github.com/charl-potgieter/SpreadsheetBI
''   If amendments are required update above and copy across
''   Below  snapshot was taken 6 July 2021
''-----------------------------------------------------------------------------\
'
''------------------------------------------------------------------------------
